...
var _ensureAuthenticated = _interopRequireDefault(require("../middlewares/ensureAuthenticated.middleware"));
...
usersRouter.delete('/users/remove', _ensureAuthenticated.default, usersController.remove);
